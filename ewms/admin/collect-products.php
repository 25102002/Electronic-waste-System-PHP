...
<!DOCTYPE html>
<head>
<title>E-Waste Management System || All Collected Product</title>
...
$ret=mysqli_query($con,"select tblproduct.ID as pid,tblproduct.ProductId,tblproduct.Status,tblproduct.ContactPerson,tblproduct.CPMobNumber,tblproduct.CreationDate,tblproduct.ProductName,tblcategory.ID,tblcategory.CategoryName,tbluser.FullName,tbluser.MobileNumber from  tblproduct join tbluser on tblproduct.UserID=tbluser.ID join tblcategory on tblproduct.CategoryID=tblcategory.ID where tblproduct.Status='Collected'");
$cnt=1;
