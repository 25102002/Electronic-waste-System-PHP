...
<!DOCTYPE html>
<head>
<title>E-Waste Management System||Search Listed Product Details </title>
...
echo $row['Status'];}
;?></td>
                  <td><a href="product-status-details.php?pid=<?php echo $row['pid'];?>&&productid=<?php echo $row['ProductId'];?>" class="btn btn-primary">View</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}} else {?>
